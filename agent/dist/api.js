...
export class OracleApi {
    ...
    async handleYields() {
        ...
        const bestByYield = formatted.reduce((a, b) => a.adjustedApyBps > b.adjustedApyBps ? a : b);
        const bestByGravity = formatted.reduce((a, b) => a.gravityScore > b.gravityScore ? a : b);
        return {
            success: true,
            data: {
                yields: formatted,
            ...
            return {
                ...
                data: {
                    currentPosition: state.currentPosition ? {
                        ...
                        protocol: PROTOCOL_NAMES[state.currentPosition.protocol],
                    } : null,
                    ...
                    history: state.history?.slice(-5).map((h) => ({
                        action: h.action,
                        from: h.fromToken,
                        to: h.toToken,
